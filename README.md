...
A modern web application for managing tasks with an AI chat assistant that can add, update, delete tasks, built with Next.js, FastAPI, OpenAI Agents SDK and PostgreSQL.
